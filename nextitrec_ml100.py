            ...
            if args.is_distilling:
                ...
                if args.distill_type != "kd" and (args.one_step or not args.pred_distill):
                    ...
                    if args.distill_type == "emd":
                        ...
                        hid_loss = emd_loss(new_student_hidden, new_teacher_hidden, new_student_attn, new_teacher_attn, mse_criterion, args, T=10)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrain_model_path', type=str, \
        default='/data1/libo/checkpoint/ml100/pkd/ckpt_24_128_40.t7')
    ...
    parser.add_argument('--teacher_model_path', type=str, \
        default='Data/checkpoint/ml100/best_scratch_model_48_256.t7')

    parser.add_argument('--log_path', type=str, default='ml100_pkd_onestep_0.05.log')
    parser.add_argument('--eval_per_epochs', default=6, type=int)
    parser.add_argument("--eval_begin_epochs", default=24, type=int)
    ...
    parser.add_argument('--output_dir', default='/data1/libo/checkpoint/ml100', type=str)
