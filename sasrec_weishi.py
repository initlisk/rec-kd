...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrain_model_path', type=str, \
        default='Data/checkpoint/sas/weishi/pkd/ckpt_24_128_50.t7')
    ...
    parser.add_argument('--pred_distill', default="true", type=str2bool)
    ...
    parser.add_argument('--teacher_model_path', type=str, \
        default='Data/checkpoint/sas/weishi/best_scratch_model_48_256.t7')

    parser.add_argument('--log_path', type=str, default='sas_weishi_pkd_onestep_tmp.log')
    ...
    parser.add_argument('--data_file', type=str, default='Data/Session/history_sequences_20181014_fajie.csv',
                        help='data path')
    parser.add_argument('--epochs', default=55, type=int)
    parser.add_argument('--output_dir', default='Data/checkpoint/sas/weishi/tmp', type=str)
    parser.add_argument('--eval_percentage', type=float, default=0.1,
                        help='0.1 means 80% training 10% testing')
